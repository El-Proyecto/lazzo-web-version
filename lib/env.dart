class Env {
  ...
  /// Development fallback group UUID for testing with mock groupIds from UI
  /// Replace with a valid groups.id that you belong to
  static const devDefaultGroupId = '30e04d95-9d0d-4d27-b3e4-97088cf2eedd';
}
