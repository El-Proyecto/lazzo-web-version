...
class _MainLayoutState extends ConsumerState<MainLayout> {
  ...
  final List<Widget> _pages = [
    ...
    const ActivitiesPage(), // 2 - Activities (moved from index 3)
  ...
  void _onNavTap(int index) {
    ...
    // NavBar: 0=Home, 1=Groups, 2=Create(skip), 3=Activities, 4=Profile
    // Pages: 0=Home, 1=Groups, 2=Activities, 3=Profile
    int pageIndex;
    switch (index) {
      case 0: // Home
        pageIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    switch (_currentIndex) {
      ...
      case 1: // Groups page -> nav index 1
        navBarIndex = 1;
        break;
      case 2: // Activities page -> nav index 3
        navBarIndex = 3;
        break;
