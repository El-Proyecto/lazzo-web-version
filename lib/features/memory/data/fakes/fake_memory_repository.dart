  ...
  static final _memories = <String, MemoryEntity>{
    'memory-1': MemoryEntity(
      ...
      photos: [
        ...
        // More grid photos with varied timestamps for clustering
        MemoryPhoto(
          id: 'photo-5',
        ...
        MemoryPhoto(
          id: 'photo-9',
          url: 'https://picsum.photos/404/504',
          thumbnailUrl: 'https://picsum.photos/404/504',
          coverUrl: 'https://picsum.photos/804/1004',
          voteCount: 3,
          capturedAt: DateTime(2024, 7, 6, 10, 0),
          aspectRatio: 0.8,
          uploaderId: 'user-1',
          uploaderName: 'Alice',
        ),
        MemoryPhoto(
          id: 'photo-10',
          url: 'https://picsum.photos/804/454',
          thumbnailUrl: 'https://picsum.photos/804/454',
          coverUrl: 'https://picsum.photos/1604/904',
          voteCount: 2,
          capturedAt: DateTime(2024, 7, 6, 10, 30),
          aspectRatio: 1.78,
          uploaderId: 'user-2',
          uploaderName: 'Bob',
        ),
        MemoryPhoto(
          id: 'photo-11',
          url: 'https://picsum.photos/405/505',
          thumbnailUrl: 'https://picsum.photos/405/505',
          coverUrl: 'https://picsum.photos/805/1005',
          voteCount: 4,
          capturedAt: DateTime(2024, 7, 6, 11, 0),
          aspectRatio: 0.8,
          uploaderId: 'user-3',
          uploaderName: 'Charlie',
        ),
        MemoryPhoto(
          id: 'photo-12',
          url: 'https://picsum.photos/805/455',
          thumbnailUrl: 'https://picsum.photos/805/455',
          coverUrl: 'https://picsum.photos/1605/905',
          voteCount: 3,
          capturedAt: DateTime(2024, 7, 6, 11, 30),
          aspectRatio: 1.78,
          uploaderId: 'user-1',
          uploaderName: 'Alice',
        ),
        MemoryPhoto(
          id: 'photo-13',
          url: 'https://picsum.photos/406/506',
          thumbnailUrl: 'https://picsum.photos/406/506',
          coverUrl: 'https://picsum.photos/806/1006',
          voteCount: 2,
          capturedAt: DateTime(2024, 7, 6, 14, 0),
          aspectRatio: 0.8,
          uploaderId: 'user-2',
          uploaderName: 'Bob',
        ),
